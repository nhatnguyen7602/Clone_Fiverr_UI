...
import "./footerTrangCongViec.css";
  ...
  return (
    <footer className="p-5 px-28 bg-gray-100 text-gray-800">
      <div className="container grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-5 text-left">
        ...
        <div className="flex flex-col space-y-4">
          <h2 className="font-bold">More From Fiverr</h2>
          <div className="flex flex-col space-y-3 text-sm text-gray-600">
            <a rel="noopener noreferrer" href="#">
              Fiverr Business
            </a>
      ...
      <div className="flex items-center justify-between text-sm">
        <div className="logoAndCopywriting flex items-baseline">
          <a
        ...
        <div className="footerRight">
          <ul className="socialMedia flex items-center mb-0">
            <li>
